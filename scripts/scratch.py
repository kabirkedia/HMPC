...
class MPC(Node):
    ...
    def __init__(self):
        ...
        """
        traj = self.waypoints = np.load('/home/kabir/sim_ws/src/mpc/traj.npy')
    ...
    def pose_callback(self, pose_msg):
        ...
        xref, self.target_ind, dref = self.calc_ref_trajectory(state, self.cx, self.cy, self.cyaw, self.sp, dl,
                                                               self.target_ind)
